...
namespace TelerikTestingFrameworkHomework
{
    ...
    public class TestCalculator : BaseTest
    {
        ...
        public void TestGrid()
        {
            ...
            var gridExample = Find.ById<HtmlControl>("example");
            Assert.AreEqual(true, gridExample.IsVisible());

            int rows = gridExample.Find.AllByTagName("tr").Count - 1;
            var colsAndRows = gridExample.Find.AllByTagName("td").Count;
            int cols = colsAndRows / rows;
